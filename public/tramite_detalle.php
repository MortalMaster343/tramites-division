...
<div class="container mt-4">
  <a href="ver_tramites.php" class="btn btn-secondary btn-sm mb-3" style="width: 200px; height: 60px;">⬅ Volver</a>
...
<?php endif; ?>
  ...
  <form method="post">
    ...
    <div class="mb-3">
      ...
      <button type="submit" name="estado" value="aprobado" class="btn btn-success btn-sm me-2" style="width: 200px; height: 60px;">✅ Aprobar</button>
      <button type="submit" name="estado" value="rechazado" class="btn btn-danger btn-sm" style="width: 200px; height: 60px;">❌ Rechazar</button>
    </div>

    <?php if ($_SESSION['rol'] === 'admin'): ?>
      <hr>
      <div class="mb-3">
        <button type="submit" name="eliminar" value="1" class="btn btn-outline-danger" style="width: 200px; height: 60px;"  onclick="return confirm('¿Estás seguro de eliminar este trámite? Esta acción no se puede deshacer.')">🗑 Eliminar trámite</button>
      </div>
    <?php endif; ?>
  </form>
  <?php endif; ?>
